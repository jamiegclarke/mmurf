...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // if first launch download all data and set launch flag to true
        if launchflag == false {
    ...
    func getRecentActivity(){
        ...
        StravaClient.sharedInstance.request(Router.athleteActivities(params: params), result: { [weak self] (activities: [Activity]?) in
            ...
            // if no activity available set error message
    ...
    // get 50 recently played song ids
    var average = 0
    func getSongId(time: Int){
        ...
        Alamofire.request(url,headers: [
                ...
                case .success(let value):
                    ...
                    // if not 50 songs, tells user to listen to more music
                    if json["items"].count != 50 {
                        ...
                        // splits data into these average segments
    ...
    func getPaces(id: Int) {
        StravaClient.sharedInstance.request(Router.activityStreams(id: id, types: "velocitySmooth"), result: { [weak self] (activities2: [StravaSwift.Stream]?) in
            ...
            // averages pace over average song length
    ...
    func getHeartrate(id: Int) {
        StravaClient.sharedInstance.request(Router.activityStreams(id: id, types: "heartrate"), result: { [weak self] (activities2: [StravaSwift.Stream]?) in
            ...
            // calculates average heartrate for average song length
    ...
    // handles loading of data, checks every second to see if arrays have been populated
    var count = 0
    func loading(id: Int) {
...
// extension of UIImage view to allow images to be loaded from URL
...
// ectention of MKMapView to allow to set map locations based on co-ordinates
extension MKMapView {
